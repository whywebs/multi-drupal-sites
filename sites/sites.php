...
/*// You need to change your main domain for each website below 
*  as 'site1' . $main_domain => 'site1', 
*  'site1' is you subdomain ++
//*/
$main_domain = '.whywebs.com';

$sites = array(
   'default' . $main_domain => 'default',
   'site1' . $main_domain => 'site1',
 );
